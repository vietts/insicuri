      ...
      {mode === 'browse' && (
        <div className="absolute top-4 left-4 right-4 z-[1000] flex items-start gap-2">
          ...
          <button
            ...
            className="shrink-0 w-10 h-10 bg-white/95 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:bg-white transition"
